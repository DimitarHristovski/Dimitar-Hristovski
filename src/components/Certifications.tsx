    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="relative">
          ...
          <motion.button
            onClick={goToPrev}
            className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-20 p-3 rounded-full backdrop-blur-sm transition-all ${
              theme === "dark"
          ...
          <motion.button
            onClick={goToNext}
            className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-20 p-3 rounded-full backdrop-blur-sm transition-all ${
              theme === "dark"
                ? "bg-dark-cosmic/80 border border-cold-steel hover:bg-dark-cosmic text-gray-300 hover:text-white"
                : "bg-white/80 border border-gray-200 hover:bg-white text-gray-700 hover:text-gray-900 shadow-lg"
            }`}
              ...
              {certificateFiles.map((filename, index) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      width: `calc((100% - ${(certificatesPerView - 1) * 1.5}rem) / ${certificatesPerView})`,
                    }}
                  >
                    <motion.div
                      className={`relative group cursor-pointer rounded-xl overflow-hidden h-full ${
                        theme === "dark"
          ...
          <>
            ...
            >
              ...
              >
                ...
                <motion.button
                  onClick={closeModal}
                  className="absolute -top-12 right-0 p-2 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white transition-all z-10"
